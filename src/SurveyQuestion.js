...
export default function SurveyQuestion({ question, answer, onAnswerChange, currentQuestionNumber, totalQuestions}) {
    ...
    return (
        <div className="w-full">
            ...
            <h3 className="text-xl font-semibold text-violet-900">Question {currentQuestionNumber} / {totalQuestions}</h3>
